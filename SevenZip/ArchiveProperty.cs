...
namespace SevenZip
{
    ...
    public struct ArchiveProperty
    {
		...
		public override bool Equals(object obj) => (obj is ArchiveProperty property) && Equals(property);
		...
		public bool Equals(ArchiveProperty afi) => afi.Name == Name && afi.Value == Value;
